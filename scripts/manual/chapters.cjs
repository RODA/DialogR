...
module.exports = [
    {
        ...
        "body": "<div class=\"callout\"><p><strong>The dataset used in this guide.</strong> Screenshots use a prepared English-labelled <strong>European Social Survey Round 9 dataset for Romania</strong>, imported as <strong>ess</strong>. It contains 1,846 cases and 345 variables. The analysis variables retain their <strong>declared</strong> classes, labels, and missing-value definitions.</p><p>Use this prepared dataset if supplied with your course. You can also obtain data from the <a href=\"https://ess.sikt.no/\">ESS Data Portal</a>; an original ESS download may have different variable names. The guide uses the prefixes in the prepared dataset, such as B1_polintr.</p></div><ol class=\"steps\"><li><strong>Start DialogR.</strong> Complete <a href=\"#packages\">desktop setup</a>, or wait for WebR to load.</li><li><strong>Choose File → Import data.</strong> Choose the European Social Survey Round 9 dataset for Romania, enter <strong>ess</strong> in <strong>Assign to</strong>, and click <strong>Import</strong>.</li><li><strong>Open the dataset editor.</strong> Explore the Data and Variables tabs. Keep the labels and missing-value definitions supplied with the file.</li><li><strong>Choose Analyze → Descriptive statistics → Frequency table.</strong> Select ess and <strong>B1_polintr</strong>, “How interested in politics”.</li><li><strong>Select Variable label and click Run.</strong> Leave Show values, Valid frequencies, and Observed only selected. No command needs to be typed.</li></ol>",
        "image": "frequencies",
    ...
    },
    {
        ...
        "image": "import",
        "caption": "Import the European Social Survey Round 9 dataset for Romania and assign it the name ess.",
        "steps": [
            "Click <strong>Browse</strong> and choose the European Social Survey Round 9 dataset for Romania, or your own supported data file.",
